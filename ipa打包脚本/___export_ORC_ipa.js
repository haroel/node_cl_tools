...
var targetConfigDatas = [
    {
        targetName : "RSLG",
        ipa_pre_name : "srzz_dev_chinatest_",
        need_clean : true,
    ...
    },
    {
        ...
        ipa_pre_name : "srzz_dist_appstore_",
        need_clean : false,
...
var PROJECT_DIR_NAME = "proj.ios_mac_orc";
var XCODE_PROJ_NAME = 'RSLG.xcodeproj';  
var PACKAGE_NAME = "com.bz.srzz";
